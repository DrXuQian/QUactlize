...
| PPU GEMV / FQ / SF comparison | Local small-library build and host/adapter checks complete; box pending | [Five-case prebuilt gate](KPACK_GEMV_FQ_SF.md): three small decode anchors plus two larger-weight M1 controls. Old/new SIMT, actual FQ/SF heuristic, common F32 endpoints, resident cores, first/warm/all-expert SF prepass and separate ACU reports. No production selection change |
