...
def main() -> int:
    ...
    require(POSTPROCESS.read_text(), (
        ...
        'MODELED_E2E_REDUCER_80PCT_NO_LAUNCH',
        ...
        'measured_product_e2e_recordable requires FULL_OUTPUT',
        'modeled_product_e2e_recordable requires the explicit 80%-bandwidth/zero-launch composite',
        'producer-only board became product E2E',
        'reducer byte/time model double-counted producer write',
        'missing reducer correctness',
        'wrong partial byte denominator',
        'missing modeled source board stayed green',
        'modeled-deployment-layout-scores.tsv',
