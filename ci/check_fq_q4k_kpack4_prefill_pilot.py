...
def check(texts: list[str]) -> None:
    runner, analyzer, policy_text, generator, driver, planner, master_text = texts
    require(runner, (
    ...
    require(analyzer, (
        ...
        "TYPED_ROWS = 210", "SOURCE_TYPED_ROWS = 918",
        '"tile_m_filter": 64',
...
def main() -> int:
    ...
    plants = (
        ...
        (0, '"source_typed_rows": 918, "typed_rows": 210',
         '"source_typed_rows": 918, "typed_rows": 209'),
        (0, "--iterations=7 --correctness-repeats=2 --only-split=0",
         "--iterations=1 --correctness-repeats=1 --only-split=0"),
        (1, "TYPED_ROWS = 210", "TYPED_ROWS = 209"),
    ...
    print("[fq-kpack4-prefill:self-test] PASS inventory-owned M2048, exact "
          "TM64=210/918 AP0 graph, raw-bit screen/scheduler/confirm and nine plants RED")
    return 0
