...
| Remaining SIMT parity | OPEN | Multi-token/grouped and other-format performance remain; 5090 recheck deferred while machine is shut down; collect local results before the next PPU comparison |
