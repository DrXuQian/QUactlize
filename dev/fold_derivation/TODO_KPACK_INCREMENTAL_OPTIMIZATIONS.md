...
| 2 | Diagnose remaining losing families | ACU REVIEWED; READER EXPERIMENT NEXT. N5120/K8192 has equal grid/block and~54% occupancy versus ref, equal DRAM bytes but3.70x L1/L2 traffic and1.78x vector loads. Isolate contiguous/cooperative A loading, metadata header reuse and dependency chains; do not repeat unchanged C/W/P sweep. Code unpack is already lop3/half2. |
