...
|---|---|---|
| 1 | Q4 cold M1 six-shape config sweep | BOX COMPLETE; PERFORMANCE TARGET OPEN. [Reviewed 393 screens,216 confirmations,24 profiles](../../docs/Q4_CONFIG_SWEEP_RESULTS_20260912.md), 603.35 s. N1024/K5120 gains14.45%; 0/6 meets ref (0% allowance), 5/6 within5% of Xplane. Retain the measured per-shape winners. |
| 2 | Diagnose remaining losing families | ACU REVIEWED; READER PREBUILT READY, BOX PENDING. [Two-shape/32-context reader factorial](../../docs/Q4_READER_REUSE_PPU.md) isolates cooperative A, cooperative units and 32-bit metadata decode, with immutable same-C/W/P raw-bit controls. PPU ISA confirms indexed shuffles and removal of 64-bit metadata shifts; no expanded workspace or new shared staging. Measure 228 cells + 24 profiles; prior ref gaps remain open until those measurements return. |
