...
| PPU six-family Q4 comparison | COMPILE-ONLY PACKAGE READY; DEVICE PENDING | [Four-arm box runner](../../docs/Q4_SIMT_PPU_COMPARISON.md): FP32 Xplane, old/new K-pack SIMT and current FQ TC selection; six dense M1 shapes, warm/rotating, complete-call timing and ACU diagnostics. No production switch before device evidence. |
