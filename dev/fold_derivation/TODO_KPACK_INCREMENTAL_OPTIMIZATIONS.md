...
|---|---|---|
| 1 | Q4 cold M1 six-shape config sweep | BOX COMPLETE; retain exact per-shape winners. [393 screens,216 confirmations,24 profiles](../../docs/Q4_CONFIG_SWEEP_RESULTS_20260912.md), 603.35 s. The subsequent reader experiments supersede these historical timings; [current combined board](../../docs/Q4_READER_FOLLOWUP_RESULTS_20260912.md) closes four of six under the updated ref+5% gate. |
| 2 | Diagnose remaining losing families | FOUR SHAPES CLOSED: N4096/K2048 +1.00%, N4096/K4096 -0.42%, N5120/K8192 +1.58%, N8192/K5120 -7.46% vs contemporaneous ref. Only N512/K2048 (+19.33%) and N1024/K5120 (+7.86%) remain. [Small-latency experiment](../../docs/Q4_SMALL_LATENCY_PPU.md): 80 contexts in five locally compiled DSOs; load issue, metadata select, A delivery and four-column ownership. BOX PENDING; 158 timing cells +10 profiles, no rerun of the four closed shapes or production switch. |
