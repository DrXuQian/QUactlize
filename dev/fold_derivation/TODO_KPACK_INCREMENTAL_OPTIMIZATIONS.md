...
|---|---|---|
| 1 | Q4 cold M1 six-shape config sweep | BOX COMPLETE; retain exact per-shape winners. [393 screens,216 confirmations,24 profiles](../../docs/Q4_CONFIG_SWEEP_RESULTS_20260912.md), 603.35 s. Subsequent reader experiments supersede these historical timings; [current combined board](../../docs/Q4_SMALL_LATENCY_RESULTS_20260912.md) closes five of six under the updated ref+5% gate. |
| 2 | Diagnose remaining losing families | FIVE SHAPES CLOSED. Latest N512/K2048 meta-h0-l1-a1-w16: 2.524766 us, +3.57% vs ref, -13.33% vs old winner; all six rounds within5%. Only N1024/K5120 remains: affine-h1-l1-a1-w10-c4-p2 5.582308 us, +5.2845% vs ref, 0.015086 us above the strict5% line. [158 cells and10 ACU reports reviewed](../../docs/Q4_SMALL_LATENCY_RESULTS_20260912.md), 244.8 s. [One-shape refinement](../../docs/Q4_MEDIUM_REFINE_PPU.md) locally compiled: exact-order constant CTA fold (P2/W10 native shared-load sites16→3, conditional branches18→3), unsigned indices at two anchors, bounded warp neighbors;22 contexts,68 timing cells and up to6 ACU reports. BOX PENDING. No closed-shape rerun or production selection change. |
