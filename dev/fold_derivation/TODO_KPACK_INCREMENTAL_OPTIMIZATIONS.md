...
| 2 | Diagnose remaining losing families | [READER BOX REVIEWED](../../docs/Q4_READER_REUSE_RESULTS_20260912.md): 228 timing cells + 24 profiles, all numeric/matched-bit gates pass, 338.63 s. N8192/K5120 v6-C4-W10-P8 beats ref 7.46%; N5120/K8192 v7-C4-W8-P4 improves 7.91% but still trails ref 1.58%. Next: bounded P8/16-byte B neighborhood plus shape-specific U/H32/A factors, then remaining four shapes. Preserve both winners; no universal switch or production promotion. |
