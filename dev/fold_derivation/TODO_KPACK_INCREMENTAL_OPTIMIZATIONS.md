...
- TASK 3, IN PROGRESS: full-BF16 dense/cuBLAS and grouped/installed-Python-DeepGEMM composition, per-call measured SF expansion and llama cross-route bindings exist as local code with initial compilation/host tests. Final packaging, provider prewarm/graph contracts, device composition and whole-model validation are not complete. No unpublished prototype is part of the endpoint admission.
...
The audited cost archive SHA256 is
