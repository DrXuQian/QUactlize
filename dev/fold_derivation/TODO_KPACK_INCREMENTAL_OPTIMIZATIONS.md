...
| PPU AIU/swzl/transpose SIMT B reader | PREBUILT + UPDATED CONTROLS READY; DEVICE PENDING | [B-transport experiment](../../docs/Q4_BLOAD_PPU.md): N16×K64 per warp, three stage/warp pairs, raw-b16 gate, exact same-topology FP32 direct/AIU comparison. Replays the latest PPU-selected Xplane/raw-reference (including WK2) and current optimized K-pack; 72 anchor timing cells + five ACU profiles, no rebuild/JIT. Canonical bytes and production unchanged. |
