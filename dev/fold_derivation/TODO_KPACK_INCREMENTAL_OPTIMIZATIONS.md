...
| PPU AIU/swzl/transpose SIMT B reader | COMPILE-ONLY ADD-ON READY; DEVICE PENDING | [B-transport experiment](../../docs/Q4_BLOAD_PPU.md): three stage/warp pairs, actual CuTe composition, device raw-b16 gate, exact same-topology FP32 direct/AIU comparison. Canonical bytes and existing shared-A/control packages unchanged. |
...
| Remaining SIMT parity | OPEN | Multi-token/grouped and other-format performance remain; 5090 recheck deferred while machine is shut down. PPU results cannot be inferred from RTX5070. |
