...
|---|---|---|
| 1 | Q4 cold M1 six-shape config sweep | BOX COMPLETE; retain exact per-shape winners. [393 screens,216 confirmations,24 profiles](../../docs/Q4_CONFIG_SWEEP_RESULTS_20260912.md), 603.35 s. Historical ref gaps:20.17%,11.79%,6.74%,6.69%,10.60%,1.75%. The reader followup supersedes the last two, not the other four. |
| 2 | Diagnose remaining losing families | TWO LARGE SHAPES CLOSED AT USER'S UPDATED5% GATE. [Reader results](../../docs/Q4_READER_REUSE_RESULTS_20260912.md): N8192/K5120 v6-C4-W10-P8 -7.46% vs ref; N5120/K8192 v7-C4-W8-P4 +1.58%. [Remaining-four followup](../../docs/Q4_READER_FOLLOWUP_PPU.md) locally compiled: 158 reader contexts, small cooperative family retained, 314 timing cells +20 ACU profiles planned. BOX PENDING. Do not rerun the two closed shapes or promote a universal switch. |
