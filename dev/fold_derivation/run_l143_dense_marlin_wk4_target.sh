...
bash "$repo/dev/fold_derivation/run_l154_wk4_a_cadence.sh"
bash "$repo/dev/fold_derivation/run_l155_wk4_indexed_converter.sh"
...
python3 "$repo/ci/check_classic_marlin_156_profile.py"
