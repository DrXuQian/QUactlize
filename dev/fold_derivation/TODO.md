...
| A10 tactic residual challenge | READY-FOR-BOX / NO-COMPILE | `policies/kpack_zw810_tactics.validation.json`: 212 requests (102 cache misses + 110 new M), 1,115 parent/workload pairs, 285 reused parents, 3x11 and correctness_repeats=1. Preserve historical same-run challengers; reuse the existing failure-isolating runner. No full Cartesian sweep or old-module deletion. Command in `docs/KPACK_POLICY.md`. |
