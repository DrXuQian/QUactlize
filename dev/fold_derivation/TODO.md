...
| A10 initialization-time tuning | SMALL-DEVICE-GATE-PASS / REAL-SHAPES-PENDING | Archive `30a86507...`, source contract `e47613f`: 50 modules / 50 contexts / 190 measured candidate-contexts / 250 positive checks / 50 detected zero-low negatives / 10 changed-router cache replays. Ten SF-dense TM8/M9 exclusions are expected. Compile 190.906 s, full harness 254.751 s; warmup calls total 89.476 ms, maximum 13.490 ms. Gate is only N256/K512 small-M/router coverage; next is bounded real-shape selection/cost validation, not another full sweep. See `docs/KPACK_WARMUP_GATE_RESULT.json`. |
