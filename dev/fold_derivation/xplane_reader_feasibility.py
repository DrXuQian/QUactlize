...
def markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "* Criterion (c) is measured for RTX 5090 Q4/A64: the pre-fast reader was 38.711 us, native metadata plus the",
        "  generic topology 12.833 us, and the public production topology 7.625 us against a 7.793 us PDF reference.",
        "  PPU instruction count and time remain unmeasured for this exact shipping path.",
