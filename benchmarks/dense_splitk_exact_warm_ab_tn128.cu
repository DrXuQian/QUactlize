/***************************************************************************************************
 * Exact warm-resident reshape A/B for the committed TN128 row.
...
bool tn128(dense_splitk_sweep::DeviceInputs const& reshape,
           dense_splitk_sweep::DeviceInputs const& internal, int iterations,
           dense_splitk_sweep::ExactWarmAbResult& result) {
  return dense_splitk_sweep::run_exact_warm_ab<8,128,128,8,16,2,0>(
