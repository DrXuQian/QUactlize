...
(
    ...
    grep -q 'KPACK_TP2_SEGMENTED_ALL PASS' "$LLAMA_DIR/tests/test-quactlize-scheduler.cpp"
    ...
    grep -qx 'KPACK_TP2_SEGMENTED_ALL PASS formats=6 cases=6 segments=3 replays=3' "$RUN/results/tp2-device-cold.log"
    ...
    grep -qx 'KPACK_TP2_SEGMENTED_ALL PASS formats=6 cases=6 segments=3 replays=3' "$RUN/results/tp2-device-hot.log"
