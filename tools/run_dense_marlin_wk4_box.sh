...
[ "$(grep -Fxc '[dense-marlin-wk4] PASS: standalone format/collective/scheduler/kernel wired; standalone tactic authority consumed; generic WK4 compatibility absent; thirteen structural plants rejected' "$LOCAL_EVIDENCE_LOG" || true)" -eq 2 ] \
