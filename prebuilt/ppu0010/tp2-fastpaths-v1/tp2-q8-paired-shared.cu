...
__global__ void point_8_2048_3072_arm_0(quactlize::fusion::DeviceCall c) {
    q8_vector::kernel_body<1,0,1,4,8,8,false,quactlize::fusion::SimtFinish>(c,1);
}
__global__ void point_8_2048_3072_arm_1(quactlize::fusion::DeviceCall c) {
    c.n=2048;c.k=3072;c.experts=1;c.mode=0;c.channels=1;c.topk=1;
    q8_vector::kernel_body<1,0,1,4,8,8,false,quactlize::fusion::SimtFinish>(c,1);
}
__global__ void point_8_2048_3072_arm_2(quactlize::fusion::DeviceCall c) {
    q8_vector::kernel_body<1,0,1,4,8,4,true,Paired16Finish>(c,1);
}
__global__ void point_8_2048_3072_arm_3(quactlize::fusion::DeviceCall c) {
    c.n=2048;c.k=3072;c.experts=1;c.mode=0;c.channels=1;c.topk=1;
    q8_vector::kernel_body<1,0,1,4,8,4,true,Paired16Finish>(c,1);
}
__global__ void point_8_2048_3072_arm_4(quactlize::fusion::DeviceCall c) {
...
extern "C" int model_gemv_run(qkg_simt_call_v2 const* input,
    ...
    case 0: {
        ...
        model_gemv::point_8_2048_3072_arm_0<<<c.rows*1*(2048/32),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 1: {
        ...
        call.input_rows=fusion->input_rows;call.status=fusion->status;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_2048_3072_arm_1<<<c.rows*1*(2048/32),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 2: {
        ...
        call.input_rows=fusion->input_rows;call.status=fusion->status;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_2048_3072_arm_2<<<c.rows*1*(2048/16),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 3: {
        ...
        call.input_rows=fusion->input_rows;call.status=fusion->status;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_2048_3072_arm_3<<<c.rows*1*(2048/16),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 4: {
        ...
        call.input_rows=fusion->input_rows;call.status=fusion->status;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_2048_3072_arm_4<<<c.rows*1*(2048/16),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
