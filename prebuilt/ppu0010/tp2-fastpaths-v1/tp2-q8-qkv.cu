...
__global__ void point_8_6144_3072_arm_0(qkg_call_v1 c) {
    register_reuse_body<8,1,1,4,8,2,0,0>(c,1);
}
__global__ void point_8_6144_3072_arm_1(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,8,4,4,false>(c,1);
}
__global__ void point_8_6144_3072_arm_2(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,8,4,4,true>(c,1);
}
__global__ void point_8_6144_3072_arm_3(qkg_call_v1 c) {
    c.n=6144;c.k=3072;c.experts=1;c.mode=0;c.channels=1;c.topk=1;
    q8_vector::kernel_body<1,0,1,8,4,4,true>(c,1);
}
__global__ void point_8_6144_3072_arm_4(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,4,8,4,true>(c,1);
}
__global__ void point_8_6144_3072_arm_5(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,8,4,4,false>(c,2);
}
__global__ void point_8_6144_3072_arm_6(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,8,4,4,false>(c,4);
}
__global__ void point_8_6144_3072_arm_7(qkg_call_v1 c) {
    q8_vector::kernel_body<1,0,1,8,4,4,false>(c,4);
}
__global__ void point_8_6144_3072_arm_8(qkg_call_v1 c) {
...
extern "C" int model_gemv_run(qkg_simt_call_v2 const* input,
    ...
    auto const& d=*input;
    auto const& c=d.call;
    if(c.qtype!=8 || c.n!=6144 || c.k!=3072 || c.experts!=1 ||
    ...
    case 0: {
        ...
        model_gemv::point_8_6144_3072_arm_0<<<c.rows*1*(6144/8),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 1: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_1<<<c.rows*1*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 2: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_2<<<c.rows*1*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 3: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_3<<<c.rows*1*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 4: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_4<<<c.rows*1*(6144/16),256,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 5: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_5<<<c.rows*2*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 6: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_6<<<c.rows*4*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 7: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_7<<<c.rows*4*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 8: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_8_6144_3072_arm_8<<<c.rows*8*(6144/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
