...
__global__ void point_14_124160_3072_arm_0(qkg_call_v1 c) {
    register_reuse_body<14,1,3,8,4,4,0,0>(c,1);
}
__global__ void point_14_124160_3072_arm_1(qkg_call_v1 c) {
    direct_metadata_body<14,1,3,8,4,4,0,0>(c,1);
}
__global__ void point_14_124160_3072_arm_2(qkg_call_v1 c) {
    c.n=124160;c.k=3072;c.experts=1;c.mode=0;c.channels=1;c.topk=1;
    direct_metadata_body<14,1,3,8,4,4,0,0>(c,1);
}
__global__ void point_14_124160_3072_arm_3(qkg_call_v1 c) {
...
extern "C" int model_gemv_run(qkg_simt_call_v2 const* input,
    ...
    auto const& d=*input;
    auto const& c=d.call;
    if(c.qtype!=14 || c.n!=124160 || c.k!=3072 || c.experts!=1 ||
    ...
    case 0: {
        ...
        model_gemv::point_14_124160_3072_arm_0<<<c.rows*1*(124160/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
    ...
    case 1: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_14_124160_3072_arm_1<<<c.rows*1*(124160/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 2: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_14_124160_3072_arm_2<<<c.rows*1*(124160/32),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
    case 3: {
        ...
        auto call=c;
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        model_gemv::point_14_124160_3072_arm_3<<<c.rows*1*(124160/16),128,0,stream>>>(call);
        if(hggcGetLastError()!=hggcSuccess) return QKG_RUNTIME;
        return hggcGetLastError()==hggcSuccess ? QKG_OK : QKG_RUNTIME;
    }
