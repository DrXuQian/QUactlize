...
EXPECTED_PARENT=3eb5e7ad6d8b244ca59972c10909345d4a4cdcd6
EXPECTED_BRANCH=artifacts/ppu0010/3eb5e7a-m8-epilogue-perf-ab-eaf274676ac0
EXPECTED_REL=prebuilt/ppu0010/3eb5e7a/m8-epilogue-perf-ab-eaf274676ac0
...
assert meta == {
    ...
    "source_tools": {
        "tools/analyze_m8_epilogue_perf_ab.py": {
            "git_blob": "2b8cd6cd5b8bc1fe960ecd6d8b5d95665c462533",
            "sha256": "43a290f1eaaaea418304499a83e7c44b339e74b67e16a6480c6413326dcbd904",
        },
        "tools/run_m8_epilogue_perf_ab_prebuilt_box.sh": {
            "git_blob": "106de5e610335ac1f56daff293e07e2c8e68b822",
            "sha256": "617fb8f2cad2252cc6e1fa99ab389aee5413d4586f3e32a5e30d74d59881075a",
        },
    },
    "payloads": {
        "bundle/bin/baseline": {
